...
output0='hydra.run.dir=./outputs/text_cross_validation/0_ver2/'
...
save0='trainer.save_dir=../../../ckpt/text/cv0_ver2'
...
nohup python src/train.py +kay=cross_text_ver2 ~data.train.path.0 ~data.val.path.0 $save0 $c0 $output0 > ./outputs/text_cross_validation/0_ver2.txt &
